...
class NodeGetLocalZeroTimeoutCase < Test::Unit::TestCase
    ...
    def test_run()
        ...
        driver.selectObjectGet(resourceID, false,
                               SAFTestUtils::SAFTestUtils.SA_AIS_OK)
        driver.clusterNodeGet(resourceID, "SA_CLM_LOCAL_NODE_ID", 0, false,
                              SAFTestUtils::SAFTestUtils.SA_AIS_ERR_TIMEOUT)
        driver.stop()
    end
end
