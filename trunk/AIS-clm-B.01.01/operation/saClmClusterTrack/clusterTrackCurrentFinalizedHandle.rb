...
class ClusterTrackCurrentFinalizedHandleCase < Test::Unit::TestCase
    ...
    def test_run()
        ...
        driver.clusterTrack(resourceID, true, false, false, false, false, false,
                            0, AISTestUtils::AISTestUtils.SA_AIS_ERR_BAD_HANDLE)
        driver.stop()
    end
end
