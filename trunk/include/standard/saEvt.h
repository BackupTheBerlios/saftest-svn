/*
  Header file of SA Forum AIS EVT APIs (SAI-AIS-B.01.00.09)
...
typedef void 
(*SaEvtChannelOpenCallbackT)(SaInvocationT invocation,
...
saEvtSelectionObjectGet(SaEvtHandleT evtHandle,
    ...
    extern SaAisErrorT 
saEvtDispatch(SaEvtHandleT evtHandle, SaDispatchFlagsT dispatchFlags);
    extern SaAisErrorT 
saEvtFinalize(SaEvtHandleT evtHandle);
    extern SaAisErrorT 
saEvtChannelOpen(SaEvtHandleT evtHandle, const SaNameT *channelName,
...
saEvtChannelClose(SaEvtChannelHandleT channelHandle);
    extern SaAisErrorT 
saEvtChannelUnlink(SaEvtHandleT evtHandle, const SaNameT *channelName);
    extern SaAisErrorT 
saEvtEventAllocate(SaEvtChannelHandleT channelHandle,
                   SaEvtEventHandleT *eventHandle);
    extern SaAisErrorT 
...
saEvtEventDataGet(SaEvtEventHandleT eventHandle,
                  ...
                  SaSizeT *eventDataSize);
    extern SaAisErrorT 
saEvtEventPublish(SaEvtEventHandleT eventHandle,
...
saEvtEventSubscribe(SaEvtChannelHandleT channelHandle,
    ...
    extern SaAisErrorT 
saEvtEventUnsubscribe(SaEvtChannelHandleT channelHandle,
                      SaEvtSubscriptionIdT subscriptionId);
    extern SaAisErrorT 
